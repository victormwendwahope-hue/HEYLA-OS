...
const mainNav = [
  ...
  { title: 'EHS', url: '/ehs', icon: ShieldCheck, items: [
    ...
    { title: 'Incidents', url: '/ehs/incidents', icon: AlertTriangle },
    { title: 'Investigations', url: '/ehs/investigations', icon: Search },
    { title: 'Hazard Register', url: '/ehs/hazards', icon: TriangleAlert },
    { title: 'Risk Assessments', url: '/ehs/risk-assessments', icon: Compass },
    { title: 'PPE', url: '/ehs/ppe', icon: HardHat },
    { title: 'Inspections', url: '/ehs/inspections', icon: ClipboardCheck },
    { title: 'Audits', url: '/ehs/audits', icon: FileCheck2 },
    { title: 'Permits', url: '/ehs/permits', icon: FileSignature },
    { title: 'Training', url: '/ehs/training', icon: GraduationCap },
    { title: 'Environmental', url: '/ehs/environmental', icon: Leaf },
    { title: 'Fleet Safety', url: '/ehs/fleet', icon: Truck },
    { title: 'Occupational Health', url: '/ehs/occupational-health', icon: HeartPulse },
    { title: 'Compliance (DOSH/WIBA)', url: '/ehs/compliance', icon: ShieldCheck },
    { title: 'Corrective Actions', url: '/ehs/corrective-actions', icon: CheckCircle2 },
    { title: 'Toolbox Talks', url: '/ehs/toolbox-talks', icon: MessagesSquare },
    { title: 'Reports', url: '/ehs/reports', icon: FileText },
  ] },
